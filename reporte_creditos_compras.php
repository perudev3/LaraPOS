                            ...
                            <?php if (is_array($clientesCredito)) : ?>
                                <?php foreach ($clientesCredito as $key => $cliente) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button title="Ver Detalles" type="button" onclick="verVenta(<?php echo $cliente['id_cliente'] ?>)" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
                                    ...
                                    <?php foreach ($objsCompras as $key => $object) : ?>
                                        <?php if ($object['Deuda'] != null) : ?>
                                            <tr>
                                                ...
                                                <?php endif; ?>
                                                <td>
                                                    <button title="Ver Detalles" type="button" onclick="detalles(<?php echo $object['id'] ?>)" title="Ver Detalles" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></button>
                                                </td>
