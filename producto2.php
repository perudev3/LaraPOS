...
$numProd = $objconn->consulta_matriz("Select count(*) as numProd from producto");
?>
        ...
        <tbody>
            ...
            <script>
                ...
                function insert(){
                    ...
                    $.post('ws/producto.php', {op: 'add',id:null,nombre:nombre,precio_compra:precio_compra,precio_venta:precio_venta,incluye_impuesto:incluye_impuesto,estado_fila:estado_fila}, function(data) {
                    if(data === 0){
                ...
                $(document).ready(function() {
                    ...
                    var tbl = $('#tb').DataTable({
                        ...
                        fnRowCallback: function( nRow, aData, iDisplayIndex ) {
                            ...
                            //     id: aData[0],
                            // }, function(response) {
                            //     $('td:eq(6)', nRow).html('<a href="#">'+response+'</a>');
                            // }, 'json');
                            ...
                            //     '<a  class="btn btn-sm btn-default" target="_blank" href="ws/producto_barcode.php?id='+aData[0]+'"><i class="fa fa-barcode"></i></a>'+
                            //     '<a title="Agregar Precios" class="btn btn-sm btn-default" href="productos_precios.php?id='+aData[0]+'" ><i class="fa fa-plus"></i></a>'+
                            //     '</div>'
                            // );
                        }
                    });
