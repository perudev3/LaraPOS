...
<body>
    ...
    AND '" . $fechaFin . " 23:59:59' AND estado_fila IN (1,2,3,4) AND total > 0
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="btn-group">
                                                        ...
                                                        <?php
                                                            //
                                                            $guia_remision = $conn->consulta_arreglo("SELECT * FROM guia_remision WHERE id_venta=".$o['id']."");
                                                            if( isset($guia_remision['id']) ){
                                                        ?>
                                                            <a title="Reimprimir Guia Remision" class="btn btn-sm btn-success" style="color:black" href='#' onclick="reimprimirg(<?php echo $o['id']?>)"><i class="fa fa-print" aria-hidden="true"></i></a>
                                                        <?php
                                                            }else {
                                                               
                                                            
                                                        ?>
                                                        <!--<a title="Generar Guia" type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-file-text-o" aria-hidden="true"></i></a>-->
                                                        <a title="Generar Guia" type="button" class="btn btn-primary" onclick="addGuia(<?php echo $o['id']?>)"><i class="fa fa-address-card" aria-hidden="true"></i></a>
                                                        <?php
                                                            }
                                                        ?>
                                                    </div>
    ...
    <div class="modal fade" id="myModalG" tabindex="-1" role="dialog" aria-labelledby="myModalLabelG">
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">GUIA REMISON</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row animate__animated animate__fadeIn">
                            <form action="" id="frm-addguia" action="ws/venta.php">
                                                    <input type="hidden" id="id_g" name="id_g">
                                                    <div class="col-md-12 min-top">
                                                        <div class="form-group">
                                                            <input required id="txtdireccionorigen" name="txtdireccionorigen" type="text" class="form-control size-form-register" placeholder="Direccion Origen">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <input required id="txtdirecciondestino" name="txtdirecciondestino" type="text" class="form-control size-form-register" placeholder="Direccion Destino">
                                                        </div>
                                                    </div>
                                                    
                                                    <div class="col-md-12 min-top">
                                                        <div class="form-group">
                                                            <input id="txtcd" name="txtcd" type="text" class="form-control size-form-register" placeholder="Documento Conductor">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 min-top">
                                                        <div class="form-group">
                                                            <input id="txtcn" name="txtcn" type="text" class="form-control size-form-register" placeholder="Nombre Conductor">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 min-top">
                                                        <div class="form-group">
                                                            <input id="txtmotivo" name="txtmotivo" type="text" class="form-control size-form-register" placeholder="Motivo">
                                                    </div>                                              
                    ...
                    <div class="modal-footer">
                        ...
                        <button form="frm-addguia" id="enviar" type="submit" class="btn btn-primary">Guardar</button>
                    </div>
                </div>
            </div>
        </div>
