...
$titulo_pagina = 'Cuadre general - Egresos';
...
$objs = $objconn->consulta_matriz("SELECT mc.`id`, c.`nombre`, mc.`monto`, `tipo_movimiento`, descripcion, `fecha`, `fecha_cierre`, `id_turno`, `id_usuario`
    ...
    WHERE mc.fecha_cierre BETWEEN '".$fecha_inicio."' AND '".$fecha_fin."' AND mc.id_caja = '{$_COOKIE["id_caja"]}' AND mc.tipo_movimiento like '%EG%'");
        ...
        <div class="col-md-12">
            <div class="panel">
                ...
                <div class='control-group col-md-4'>
                    ...
                    <input class='form-control' type='text' placeholder="N° Comprobante" id='comprobante' name='comprobante' />
                </div>
            ...
            <?php
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="label label-danger">Pago Externo</span>
                        </td>
                        ...
                        <td>
                            <?php 
                                ...
                                $obj_usuario->setVar('id', $o['id_usuario']);
                                $obj_usuario->getDB();
...
<script>
    ...
    function new_payment(){
        ...
        var monto = $("#monto").val();
        var tipo_movimiento = "EG|PEN|EFECTIVO|PX";
    ...
    function sel(id){
        $.post('ws/movimiento_caja.php', { op:'get_', id: id }, function(response){
            ...
            $("#comprobante").val(movimiento.split("|")[4]);
