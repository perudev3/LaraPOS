...
$.post('ws/producto_venta.php', {op: 'add',id:id,id_venta:id_venta,id_producto:id_producto,precio:precio,cantidad:cantidad,total:total,estado_fila:estado_fila}, function(data) {
if(data === 0){
$('body,html').animate({
scrollTop: 0
}, 800);
...
$.post('ws/producto_venta.php', {op: 'mod',id:id,id_venta:id_venta,id_producto:id_producto,precio:precio,cantidad:cantidad,total:total,estado_fila:estado_fila}, function(data) {
if(data === 0){
$('body,html').animate({
scrollTop: 0
}, 800);
...
function sel(id){
$.post('ws/producto_venta.php', {op: 'get', id: id}, function(data) {
if(data !== 0){
...
function del(id){
$.post('ws/producto_venta.php', {op: 'del', id: id}, function(data) {
if(data === 0){
$('body,html').animate({
scrollTop: 0
}, 800);
...
$.each(data, function(key, value) {
ht += '<tr>';
    ht += '<td><a href="#" onclick="sel_id_producto('+value.id+')">SEL</a></td>';ht += '<td>'+value.id+'</td>';ht += '<td>'+value.nombre+'</td>';ht += '<td>'+value.descripcion+'</td>';ht += '<td>'+value.precio_compra+'</td>';ht += '<td>'+value.precio_venta+'</td>';ht += '<td>'+value.incluye_impuesto+'</td>';
    ht += '</tr>';
});
...
echo $gl_producto_venta_id_venta;
?>);
...
echo $gl_producto_venta_id_producto;
?>);
