...
swal("Se registro correctamente","Caracteristicas Servicio","success");
location.reload();
}
}, 'json');
}
...
swal("Se actualizo correctamente","Caracteristica servicio","success");
location.reload();
}
}, 'json');
}
...
function del(id){
    Swal.fire({
        title: 'Eliminar Caracteristica Servicio',
        text: "¿Desea eliminar caracteristica servicio?",
            ...
            if (result.value === true) {
                $.post('ws/taxonomias.php', {op: 'del', id: id}, function(data) {
                    ...
                    swal("Oh no se pudo eliminar", "Error", "error");
                        ...
                        swal("Se elimino correctamente", "Caracteristica Servicio eliminada", "success");
                        location.reload();
                    }
                }, 'json');
            }
