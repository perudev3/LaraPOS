...
$.post('ws/boleta.php', {op: 'add',id:id,id_venta:id_venta,token:token,serie:serie,estado_fila:estado_fila}, function(data) {
if(data === 0){
$('body,html').animate({
scrollTop: 0
}, 800);
...
$.post('ws/boleta.php', {op: 'mod',id:id,id_venta:id_venta,token:token,serie:serie,estado_fila:estado_fila}, function(data) {
if(data === 0){
$('body,html').animate({
scrollTop: 0
}, 800);
...
function sel(id){
$.post('ws/boleta.php', {op: 'get', id: id}, function(data) {
if(data !== 0){
...
function del(id){
$.post('ws/boleta.php', {op: 'del', id: id}, function(data) {
if(data === 0){
$('body,html').animate({
scrollTop: 0
}, 800);
