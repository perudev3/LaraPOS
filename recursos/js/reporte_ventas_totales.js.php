...
$(document).ready(function () {
   ...
   $('#tblKardex').DataTable({
    ...
    $("#frm-addguia").on('submit', function(e){
        //e.preventDefault();
        let id = $('#id_g').val();
        let origen = $('#txtdireccionorigen').val();
        let destino = $('#txtdirecciondestino').val();
        let cd = $('#txtcd').val();
        let cn = $('#txtcn').val();
    ...
    function limpiarFrmGuia()
    {
        document.getElementById("id_g").value = "";
    }
...
function reimprimirg(id) {
    console.log("entroo")
    window.open('archivos_impresion/remision.php?id=' +id , '_blank');
    // location.href = "remision.php?id=fecha2;
}
