...
$.post('ws/taxonomiav.php', {op: 'add',id:id,padre:padre,nombre:nombre,tipo_valor:tipo_valor,estado_fila:estado_fila}, function(data) {
if(data === 0){
$('body,html').animate({
scrollTop: 0
}, 800);
...
$.post('ws/taxonomiav.php', {op: 'mod',id:id,padre:padre,nombre:nombre,tipo_valor:tipo_valor,estado_fila:estado_fila}, function(data) {
if(data === 0){
$('body,html').animate({
scrollTop: 0
}, 800);
...
function sel(id){
$.post('ws/taxonomiav.php', {op: 'get', id: id}, function(data) {
if(data !== 0){
...
function del(id){
$.post('ws/taxonomiav.php', {op: 'del', id: id}, function(data) {
if(data === 0){
$('body,html').animate({
scrollTop: 0
}, 800);
