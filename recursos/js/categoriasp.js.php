...
swal("Se registro correctamente","Categoria","success");
location.reload();
}
}, 'json');
}
...
swal("Se actualizo correctamente","Categoria","success");
location.reload();
}
}, 'json');
}
            ...
            if (result.value === true) {
                $.post('ws/taxonomiap_valor.php', {op: 'del', id: id}, function (data) {
                    ...
                    swal("Oh no se pudo eliminar", "Error", "error");
                        ...
                        swal("Se elimino correctamente", "Categoria eliminada", "success");
                        location.reload();
                    }
                }, 'json');
            }
