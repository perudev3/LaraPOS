...
if (isset($_POST['op'])) {
    switch ($_POST['op']) {
        ...
        case 'del':
            ...
            $consulta = $objcliente->consulta_matriz("SELECT * FROM venta WHERE id_cliente = ".$_POST['id']);
            $objcliente->setVar('id', $_POST['id']);
            if(empty($consulta)){
        ...
        case 'getdocumento':
            ...
            echo "primero ".json_encode($res);
            if ($res == 0) {
                echo json_encode(_test_type_document($_POST['doc']));
            } else {
