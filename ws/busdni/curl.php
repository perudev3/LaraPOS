<?php
	...
	class cURL
	{
		...
		public function sendHeadersR( $url, $post = array())
		{
			$this->_post = false;
			$this->_binary = false;
			if( count($post)!=0 )
			...
			$this->setHttpHeader( array('Content-Type'=>'application/x-www-form-urlencoded') );
			$this->setHttpHeader( array('Requestverificationtoken' => '30OB7qfO2MmL2Kcr1z4S0ttQcQpxH9pDUlZnkJPVgUhZOGBuSbGU4qM83JcSu7DZpZw-IIIfaDZgZ4vDbwE5-L9EPoBIHOOC1aSPi4FS_Sc1:clDOiaq7mKcLTK9YBVGt2R3spEU8LhtXEe_n5VG5VLPfG9UkAQfjL_WT9ZDmCCqtJypoTD26ikncynlMn8fPz_F_Y88WFufli38cUM-24PE1') );
