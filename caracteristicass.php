...
$titulo_pagina = 'Caracteristicas Servicio';
...
$obj = new taxonomias();
$objs = $obj->consulta_matriz("Select * from taxonomias where estado_fila = 1 AND id > 3");
?>
            ...
            if (is_array($objs)):
                foreach ($objs as $o):
                    ...
                    <tr>
                        ...
                        <td>
                            <a href='valoress.php?id=<?php echo $o["id"];?>'><i class="fa fa-eye" aria-hidden="true"></i></a>
                        </td>
                        <td>
