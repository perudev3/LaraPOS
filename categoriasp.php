...
$titulo_pagina = 'Categorias Producto';
...
$objs = $obj->consulta_matriz("Select * from taxonomiap_valor where id_taxonomiap = '2' and estado_fila = 1");
            ...
            if (is_array($objs)):
                foreach ($objs as $o):
                    ...
                    <tr>
                        ...
                        <td><a href='tiposp.php?id=<?php echo $o['id']; ?>&categoria=<?php echo urlencode($o["valor"]);?>'><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                        <td>
                            <?php if($o['id']>3){ ?>
