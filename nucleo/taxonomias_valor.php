...
class taxonomias_valor extends SuperClass {

    private $inputvars = array();
    private $inputname = 'taxonomias_valor';

    function __construct($id = NULL, $id_taxonomias = NULL, $valor = NULL, $padre = NULL, $estado_fila = NULL) {
