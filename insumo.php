...
<section class="col-md-12">    
    ...
    <form id="form_reg" name="form_reg">
        ...
        <div class="col-md-12 alert alert-danger" role="alert" style="display: none;" id="idalert">
            ...
            <div class="form-group col-md-6 col-sm-6 col-12 col-lg-6 col-xs-6" >
                <label for=""> Unidad de Medida <span class="text-danger"> * </span> </label>
                <select name="id_unidad_medida_insumo_porcion" id="id_unidad_medida_insumo_porcion" class="form-control selectpicker" title=" -- Seleccione una Unidad de Medida --" required>
                    <?php
