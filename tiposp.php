...
$objs = $obj->consulta_matriz("Select * from taxonomiap_valor where id_taxonomiap = '3'  and padre = '".$_GET["id"]."' and estado_fila = 1");
            ...
            if (is_array($objs)):
                foreach ($objs as $o):
                    ...
                    <tr>
                        ...
                        $objtaxonomiap_valor->setVar('id', $o['padre']);
                        $objtaxonomiap_valor->getDB();
                        echo $objtaxonomiap_valor->getValor();
                        ?></td>
