...
<div class='control-group col-md-4'>
    ...
    <label class='form-control' id='txt_id_taxonomias'>...</label>
    <input type='hidden' name='id_taxonomias' id='id_taxonomias' value=''/>
</div>
...
$objs = null;
if(isset($_GET["id"])){
    $objs = $obj->consulta_matriz("Select * from taxonomias_valor where id_taxonomias = '".$_GET["id"]."' and estado_fila = 1");
...
<div class='contenedor-tabla'>
    <table id='tb' class='display' cellspacing='0' width='100%'>
        ...
        <tbody>
            ...
            if (is_array($objs)):
                foreach ($objs as $o):
                    ...
                    <tr>
                        ...
                        $objtaxonomias->setVar('id', $o['id_taxonomias']);
                        $objtaxonomias->getDB();
                        echo $objtaxonomias->getVar($gl_taxonomias_valor_id_taxonomias);
                        ?></td>
            ...
            ?>
            <?php
            $nombre_tabla = 'valoress';
            require_once('recursos/componentes/footer.php');
            if(isset($_GET["id"])):?>
            <script>
                $(document).ready(function() {
                    sel_id_taxonomias(<?php echo $_GET["id"];?>);
                });
            </script>
