...
$hash = $objcon->consulta_arreglo("SELECT * FROM new_comprobante_hash WHERE estado=1 AND pkComprobante =".$boleta['id']);
...
<p class="title"><b><?php echo $config['serie_boleta'] ."-". str_pad($boleta['id'], 8, "0", STR_PAD_LEFT); ?></b></p>
