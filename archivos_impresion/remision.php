...
$guia_remision = $objcon->consulta_arreglo("SELECT * FROM guia_remision where id_venta = ".$_GET["id"]);
if($venta["tipo_comprobante"]==0 && $venta["id_cliente"]>0 ){
    $cliente_nota=$cliente;
    $cliente_nota["cliente"]=$cliente["nombre"];     
}

if(empty($cliente_nota)){
    $cliente_nota=$cliente;
    $cliente_nota["cliente"]=$cliente["nombre"];             
}
...
<hr>
<p class="title"><b>GUIA REMISION <?php echo $config['serie_guia_remision']; ?>  - <?php echo str_pad($guia_remision['correlativo'], 8, "0", STR_PAD_LEFT) ?></b></p>
...
<table align="center">
    ...
    <tr>
        <td>Origen</td>
        <td>: <?php echo $guia_remision['origen'];?> </td>
    </tr>

    <tr>
        <td>Destino</td>
        <td>: <?php echo $guia_remision['destino'];?> </td>
    </tr>

    <tr>
        <td>Motivo</td>
        <td>: <?php echo $guia_remision['motivo'];?> </td>
    </tr>

	<tr>
        <td>Doc Conductor</td>
        <td>: <?php echo $guia_remision['cd'];?> </td>
    </tr>

<tr>
        <td>Nombre Conductor</td>
        <td>: <?php echo $guia_remision['cn'];?> </td>
    </tr>
