...
<div class='control-group col-md-6'>
    ...
    <!-- <p class='help-block'><a href='#modal_id_producto' data-toggle='modal' id="botton_abrir_modal_producto"  >Seleccionar</a></p> -->
...
<div class='control-group col-md-12' style="margin-top: 27px;">
    <p></p>
...
<div class='contenedor-tabla'>
    <table id='tb' class='display' cellspacing='0' width='100%'>
        ...
        <tbody>
            ...
            ?>
            <?php
            $nombre_tabla = 'movimiento_producto_guia';
