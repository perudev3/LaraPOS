    ...
    <div class="container-fluid">
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        <label for="caja" class="col-sm-2 control-label">Almacen:</label>
                        <div class="col-sm-10">
                            <div class="input-group">
  ...
  <select class="form-control" style="display: none">
                ...
                data-pagination-next-text="Siguiente">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th rowspan="2" class="text-center" data-sortable="true" data-field="unidad">Unidad</th>
                        ...
                        <tr>
                            ...
                            <th class="text-center" data-field="pcompra" data-sortable="true" data-cell-style="">Precio Compra</th>
                            <th class="text-center" data-field="pventa" data-sortable="true" data-cell-style="">Precio Venta</th>
                            <th class="text-center" data-field="utilidad" data-sortable="true" data-cell-style="">Utilidad</th>

                            <th class="text-center" data-field="pcompra_st" data-sortable="true" data-cell-style="">Sub Total Precio Compra</th>
                            <th class="text-center" data-field="pventa_st" data-sortable="true" data-cell-style="">Sub Total Precio Venta</th>
                            <th class="text-center" data-field="utilidad_st" data-sortable="true" data-cell-style="">Sub Total Utilidad</th>
    ...
    <div class='panel contenedor-tabla'>
        <div class="col-md-4" style="text-align: right;">
            ...
            <span id="tcompra">0.00</span>
        </div>
        <div class="col-md-4" style="text-align: right;">
            <label>TOTAL VENTA: </label>
            <span id="tventa">0.00</span>
        </div>
        <div class="col-md-4" style="text-align: right;">
            <label>TOTAL UTILIDAD: </label>
            <span id="tutilidad">0.00</span>
        </div>
    </div>
</div>      
                <div class="tabla2">
